...
const stats = [
  ...
  { icon: Calendar, label: "Events/Year", value: "50+", description: "Regular workshops, seminars, and competitions" },
  { icon: Globe, label: "Network", value: "Global", description: "Connected to CSI chapters worldwide" },
