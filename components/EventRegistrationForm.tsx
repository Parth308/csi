  ...
  const SelectField = ({ id, label, icon: Icon, options, value, onChange }: SelectFieldProps) => (
    <div className="flex-1">
      ...
      <div className="relative mt-2">
        <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary-light">
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
        <Card className="bg-background-lighter p-4 sm:p-6 md:p-8 rounded-xl md:rounded-2xl shadow-card">
          ...
          <div className="space-y-3 md:space-y-4">
              <h3 className="text-xl md:text-2xl text-primary font-semibold">Event Selection</h3>
